...
CREATE TABLE public.users (
    ...
    search_id integer,
    recovery_password_expired_at timestamp(6) without time zone
);
...
--
-- Name: index_users_on_search_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_users_on_search_id ON public.users USING btree (search_id);
